...
//	$("#somemenu li a").click(function() {
   ...
   var setDate =  $("#startDate").val().toUpperCase() ;
   ...
   switch(this.id) {
     case 'alld':
    	 ...
    	 sql = sql + " ,trim(to_char(to_date(add_time,'YYYY-MM-DD HH24:MI:SS'), 'MONTHYYYY'))  MonthYear "  ;
    	...
    	sql = sql + " where REPLACE(trim(to_char(to_date(d.add_time,'YYYY-MM-DD HH24:MI:SS'), 'MONTHYYYY') ),chr(32), '') = '" + setDate  + "'";
     ...
     case 'assigned':
    	 ...
    	 sql = sql + " and REPLACE(trim(to_char(to_date(d.add_time,'YYYY-MM-DD HH24:MI:SS'), 'MONTHYYYY') ),chr(32), '') = '" + setDate  + "'";
    	 var posting = $.post("newReportQuery2_p.jsp", {sql : sql});
    	 posting.done(function( data ) {   
