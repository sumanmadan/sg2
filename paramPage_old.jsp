...
<h1>Submit Parametric Request</h1>
...
<div id = formbar >           
<form id="f1" name = "f1" method=post action=uploadServlet_DB enctype="multipart/form-data"  target=_blank >
...
<div id = estpd name = "estpd" style="display:none"> </div>
             ...
             <table id=tid border="0">
                  <tr>
                    <td><span class="hl">Others Comment : </span></td>
                    <td><textarea name="comment" id = "comment" required rows="4" cols="50">
					</textarea></td>
					          
                  </tr>
                 
                  <tr>
                    <td><span class="hl">Lot Purpose : </span> </td>
                    <td><textarea name="lotpurpose" id = "lotpurpose" rows="4" cols="50" required></textarea></td>
                </tr>
             
             
                <tr>
                    <td><span class="hl">Lot:(can be blank for parametric testing) </span></td>
