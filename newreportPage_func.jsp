 ...
 $("input[type='button']").click(function() {
   ...
   switch(this.id) {
     case 'alld':
    	 ...
    	 var sql ="select d.ticket_no,d.g1,d.g2,d.g3,d.tech,d.prod,d.comments,d.lotpurpose,d.lot,wafers,d.sampling,d.temp,d.login_id,d.fname,d.rdate,d.add_time,nvl((aa.alll),'unassigned')full_list ";
    	 ...
    	 var posting = $.post("newReportQuery_f.jsp", {sql : sql});
...
<input type=button id="none" name="none" value="Unassinged" class="btype">
