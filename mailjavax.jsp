...
try {
 ...
 InternetAddress[] addressTo = new InternetAddress[to.length];
  ...
  String link1= "Click to check your Ticket/Updates	: http://fc8tdyt03.gfoundries.com:8080/MSR/ticketLinkP?id=" + tticketno  ;
  String note = "PLEASE DO NOT REPLY TO : fc8tdtsr@globalfoundries.com " ;
  
  content = "Ticket No# : " + tticketno + "\n" +  content + "\n" + "\n"  +   link + "\n"  + link1  + "\n" + "\n" + note;
  
  String subjectH = "Test Request System-New Parametric Request " + " Ticket No#" + tticketno;
  ...
  // message.setSubject("Test Request System - New Parametric Request, Check the Web Link");
...
%>
<html>
<p align="center">A Message has been sent on the Request to the Parametric Group<br></p>
