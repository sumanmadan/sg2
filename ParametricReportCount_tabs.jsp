...
posting.done(function( data ) {  
	...
	break;
	 ...
	 case 'Monthly' :
		 ...
		 $("#container").empty();
		 $('#spinner').show();
		 var posting = $.post("newReportQuery2_p_monthly.jsp");
		 posting.done(function( data ) {   
...
<div id="tabs">
    <ul>
        ...
        <li id="alld"><a href="#fragment-4">All</a></li>
        <li id="PerMonth"><a href="#fragment-5">PerMonthCount</a></li>
        <li id="PerMonthPerWeek"><a href="#fragment-6">PerMonthPerWeek</a></li>
         <li id="Monthly"><a href="#fragment-7">Monthly</a></li>
        <li id="TimeTaken"><a href="#fragment-8">TimeTakenPerTicket</a></li>
         <li id="drawC"><a href="#fragment-9">Refresh Chart</a></li>
    </ul>
 </div>   
