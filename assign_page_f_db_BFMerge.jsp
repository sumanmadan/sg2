...
<form method="post" action="updateServlet_assign_f_db" >
...
<th class="headcol">Product</th>
<th class="headcol">Sub Product</th>
...
<td><a class="three" href="<%=request.getContextPath()%>/QueryStringD_F?id=<%=idd%>" target="_Blank"><%=  rs.getString("g1")%></a></td>
<!--  <td class="headcol"><%= rs.getString("g1") %></td> -->
<td class="headcol" ><%= rs.getString("prod") %></td>
<td class="headcol"><%= rs.getString("spdt") %></td>
...
<td class="fixed-width" ><%= rs.getString("rremarks") %></td>
</tr>
