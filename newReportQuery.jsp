...
<td><div class="one"><a href="<%=request.getContextPath()%>/QueryStringD_P?id=<%=idd%>" target="_Blank"><%=  rs.getString("ticket_no")%></a></div></td>
...
<% if (desc.indexOf("Assigned") >0 && desc.indexOf("Completed") < 0 && desc.indexOf("Rejected") < 0) {
	%>
	<td bgcolor="LightYellow"><%= desc.replaceAll("#", "\n")%></td>
