...
<li><a href="searchP.jsp">Search my Parametric</a></li>
<li><a href="searchF.jsp" target=_blank>Search my Functional</a></li>
</ul>

<h2>Admin</h2>
<ul>
<li><a href="admin.jsp">Page for TD Test Group updates</a></li>
</ul>
</div>
