    ...
    $("#searchbb").click( function()
    	       {
    	    	var v = $('#searchtextt').val();
    	         //alert('button clicked' + v );
    	         var posting = $.post("searchFunTicket.jsp", {pdt : v});
    	         posting.done(function( data ) { 
    	        	//alert("gosh 3 " + data);
    	        	//$('#dropdownp').empty().append(data);  
    	        	$('#mainContent').html(data);
...
<h2> Functional Test Request System </h2>
...
<form id="searchbox" name= "searchbox">
   <p>1) Enter Email Address </p>
    ...
    <button type=button id="searchb" name="searchb" class="balagade"> Search your Request</button>
    <br>
    <p> OR </p>
    <p>2) Enter Ticket# </p>
