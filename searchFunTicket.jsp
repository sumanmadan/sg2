...
String TicketSearch = request.getParameter("pdt");
...
sql = sql + "aa on aa.ticket_no=d.ticket_no where d.ticket_no = " + TicketSearch ;
...
<td class="fixed-width"><div class="one"><a href="<%=request.getContextPath()%>/QueryStringD_F?id=<%=idd%>" target="_Blank"><%=  rs.getString("ticket_no")%></a></div></td>
