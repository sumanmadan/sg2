...
import javax.servlet.http.HttpServletRequest;
import javax.servlet.http.HttpServletResponse;
@WebServlet("/updateServlet_assign_f_db_P")
@MultipartConfig(maxFileSize = 16177215)    // upload file's size up to 16MB
public class updateServlet_assign_f_db_P extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request,
        ...
        Iterator<Entry<String, String[]>> it = set.iterator();
    	  ...
    	  List<String> pp = new ArrayList<String>();
                         ...
                         for (int i = 0; i < paramValues.length; i++) {
                           ...
                           if (paramName.matches("ticckk" )) {
                             ...
                             if (paramName.matches( "prio" )) {
                          	   ...
                          	   //out.println("iisdf");
                          	   for (int i = 0; i < paramValues.length; i++) {
                          		 System.out.println("Priority  --" + paramValues[i]);
                          		// comm = paramValues[i];
                          		 prio = paramValues[i];
    	     ...
    	     // System.out.println("For " + t.size() + "  bbbbb -- "  +  b.size() + " aaa---- " + a.size() + "\n"  ); 
    	      try{
    	           for ( int j = 0; j < b.size();j++)
    	           {
                         ...
                         st = "Insert into msr_assign_f(ticket_no,assignee,status,comments,updated_time,priority) values (?,?,?,?,?,?)";
                         ...
                         message_long = "Ticket_no :" + ticket_no + "\n" + "Assignee :" + assignee + "\n" + "Status :" + status + "\n" + "Comments : " + comm + "\n" +  "\n" + "  Coming with Priority "+ prio + "Updated time :" +  str ;
                ...
                InternetAddress[] addressTo = new InternetAddress[to.length];
                 ...
                 String link1= "Click to check your Ticket/Updates			: http://fc8tdyt03.gfoundries.com:8080/MSR/ticketLinkF?id=" + ticket_no  ;
                 ...
                 if ( fout.equalsIgnoreCase("No attachment")) {
                  ...
                  message.setSubject("Test Request System-Functional Request is Updated-Ticket#" +ticket_no);
                  message.saveChanges();
    	   ...
    	   // getServletContext().getRequestDispatcher("/mailx_update_f.jsp").forward(request, response);
