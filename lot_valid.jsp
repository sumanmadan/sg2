...
System.out.println("product..." + pdt + "<br>");
...
String sql = "select unique wafer_id from wafer_to_lot where lot_id ='" + pdt + "'"  ;
System.out.println("to sql..." + sql+ "\n");
try{
...
while( rs.next() ){
    s1 = rs.getString(1);
    s2= rs.getString(1);
    System.out.println("to data.." + s1+ "\n");
  %> 
  
 
 <input type="checkbox" id = "c1[]" name="c1[]"  value=<%=s1 %> ><%=s1 %> 
